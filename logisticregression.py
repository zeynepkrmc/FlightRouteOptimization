...
def load_and_clean_data(file_path):
    """
    Veriyi yükler, temizler ve yeni özellikler oluşturur.
    """
...
def train_logistic_regression(df):
    """
    Logistic Regression modeli eğitir, çapraz doğrulama ve MSE hesaplar.
    """
    ...
    return model, scaler, X_train_scaled, y_train, X_test_scaled, y_test, y_pred
...
if __name__ == "__main__":
    ...
    model, scaler, X_train, y_train, X_test, y_test, y_pred = train_logistic_regression(data)
